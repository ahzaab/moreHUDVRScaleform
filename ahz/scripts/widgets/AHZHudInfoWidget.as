...
class ahz.scripts.widgets.AHZHudInfoWidget extends MovieClip
{
	...
	public function AHZHudInfoWidget()
	{
		...
		//hookFunction(_root._level0.HUDMovieBaseInstance,"ShowElements",this,"ShowElements");
			//hookFunction(_root._level0.HUDMovieBaseInstance,"SetCompassAngle",this,"SetCompassAngle");
			_global.skse.plugins.AHZmoreHUDPlugin.InstallHooks();
			hooksInstalled = true;
		}
			/*	
_global.skse.plugins.AHZmoreHUDPlugin.AHZLog("_root.VRActivateRolloverInstance: " + _root.VRActivateRolloverInstance);	
			
		
			_global.skse.plugins.AHZmoreHUDPlugin.AHZLog("getting root items");			
			for (var o in _root)
			{
				_global.skse.plugins.AHZmoreHUDPlugin.AHZLog(" " + o + ":" + _root[o]);
				for (var o1 in this[o])
				{
					_global.skse.plugins.AHZmoreHUDPlugin.AHZLog("         " + o1 + ":" + _root[o][o1]);
					for (var o2 in _root[o][o1])
					{
						_global.skse.plugins.AHZmoreHUDPlugin.AHZLog("                  " + o2 + ":" + _root[o][o1][o2]);
					}					
				}						
			}		*/
			
			_global.skse.plugins.AHZmoreHUDPlugin.AHZLog("_root.VRActivateRolloverInstance.SetCrosshairTarget: " + _root.VRActivateRolloverInstance.SetCrosshairTarget);
		...
		showTargetWarmth = false;   // Always show. This matches the Games logic if survival mode is enabled
